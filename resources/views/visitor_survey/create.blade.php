                ...
                <div class="w-full p-4">
                    <div class="mb-6">
                        <label for="survey_scale"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">{{ __('Survey Scale') }}</label>
                        <div class="flex flex-wrap justify-between">
                            @for ($i = 1; $i <= 10; $i++)
                                <div class="w-1/5">
                                    <label for="survey_scale_{{ $i }}"
                                        class="block text-sm font-medium text-gray-700 dark:text-black">{{ $i }}</label>
                                    <input id="survey_scale_{{ $i }}" type="radio" name="survey_scale"
                                        value="{{ $i }}"
