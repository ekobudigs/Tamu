                    ...
                    <div
                        ...
                        <div class="mb-6">
                            ...
                            <input id="no_visitors" type="text"
                                ...
                                name="no_visitors" value="{{ $visitor->no_visitors }}" required readonly autofocus>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input id="guest_name" type="text"
                                ...
                                name="guest_name" value="{{ $visitor->guest_name }}" required autocomplete="guest_name">
                            @error('guest_name')
                        ...
                        <div class="mb-6">
                            ...
                            <input id="email" type="text"
                                ...
                                name="email" value="{{ $visitor->email }}" required autocomplete="email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="address"
                                ...
                                name="address" required autocomplete="address">{{ $visitor->address }}</textarea>
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div
                        ...
                        <div class="mb-6">
                            ...
                            <input id="office_institution_name" type="text"
                                ...
                                name="office_institution_name" value="{{ $visitor->office_institution_name }}" required
                        ...
                        <div class="mb-6">
                            ...
                            <input id="number_of_people" type="text"
                                ...
                                name="number_of_people" value="{{ $visitor->number_of_people }}" required
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="purpose"
                                ...
                                name="purpose" required autocomplete="purpose">{{ $visitor->purpose }}</textarea>
                            @error('purpose')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
